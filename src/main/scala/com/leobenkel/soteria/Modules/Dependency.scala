...
case class Dependency(
  ...
  @transient lazy val exclusionRule: Either[String, ExclusionRule] =
    nameObj.exclusionRule
  ...
  @transient lazy val toSerializedModule: SerializedModule = SerializedModule(
    ...
    needDoublePercent = ModuleDefaults.toOptionWithDefault(
    ...
    overrideIsEnough = ModuleDefaults.toOptionWithDefault(
      ModuleDefaults.OverrideIsEnough,
      this.overrideIsEnough
    ),
    forbidden = this.forbidden,
    shouldBeProvided = ModuleDefaults.toOptionWithDefault(
  ...
  @transient lazy val toModuleID: Either[String, ModuleID] =
    version.flatMap(nameObj.toModuleID)
