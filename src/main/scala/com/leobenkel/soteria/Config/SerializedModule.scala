...
case class SerializedModule(
  ...
  def toNameOfModule(
    ...
    NameOfModule(
      ...
      needDoublePercent =
        this.needDoublePercent.getOrElse(ModuleDefaults.NeedDoublePercent)
    )
  ...
  def toDependency(
    ...
    val errors = parsedDependencies.flattenLeft ++ parsedScalaVersion
      .flattenLeft
    ...
    (
      Modules.Dependency(
        ...
        shouldDownload =
          this.shouldDownload.getOrElse(ModuleDefaults.ShouldDownload),
        shouldBeProvided =
          this.shouldBeProvided.getOrElse(ModuleDefaults.ShouldBeProvided),
        overrideIsEnough =
          this.overrideIsEnough.getOrElse(ModuleDefaults.OverrideIsEnough),
