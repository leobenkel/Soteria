...
private[soteria] trait SoteriaExecutionLogic
    ...
    with TaskDebugModule with TaskDependencyOverrides with TaskScalac with TaskUpdate
    with TaskGetAllDependencies with TaskCheckDependencies with AddScalaFixCompilerPlugin
